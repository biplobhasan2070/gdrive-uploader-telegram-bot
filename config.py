...
class Config:
  ...
  if ENV:
    BOT_TOKEN = os.environ.get('1959694150:AAH7dhOX5bvRH7oKiYh5SZqMoV9Kfn_9S_Y')
    APP_ID = os.environ.get('5310709')
    API_HASH = os.environ.get('63a546bdaf18e2cbba99f87b4274fa05')
